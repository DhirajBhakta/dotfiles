...
vim.opt.wildignore:append("*/node_modules/**,*/venv/**,*/.git/*,*.jpg,*.png,*.zip,*.gz,*.tar,*.pyc")
...
--legacykeymaps
vim.keymap.set("v", "clip", ":w !pbcopy<CR><CR>")
vim.keymap.set("n", "crun", ":!g++ % -o %< && ./%< && rm %<<CR>")
...
--legacykeymaps(from myold config)
vim.keymap.set("n", "copen", ":copen<CR>")
vim.keymap.set("n", "ccl",   ":ccl<CR>")
vim.keymap.set("n", "cnext", ":cnext<CR>")
